    ...
    return (
        <section className="property-sale">
            <div className="property-sale__container">
                ...
                <button className="property-sale__button">Подробнее</button>

                <div className="property-sale__intro">
                    <p className="property-sale__intro-text">
                        Оценим ваш объект, подготовим к продаже, обеспечим
                        профессиональное продвижение и полное юридическое
                        сопровождение. Кроме того, обеспечим дополнительный
                        доход собственнику на время продажи объекта.
                    </p>
                </div>
                ...
                <div className="property-sale__advantages">
                    ...
                    <ul className="property-sale__list">
                        ...
                        <li className="property-sale__item">
                            возможность срочного выкупа или альтернативной
                            сделки
                        </li>
                    </ul>
                </div>
                    ...
                    <div className="property-sale__steps-card">
                        {saleSteps.map((step) => (
                            <div key={step.number} className="sale-step">
                                <div className="sale-step__number">
                                    {step.number}
                                </div>
                ...
                <div className="property-sale__bonus-section">
                    ...
                    <div className="property-sale__bonus-content">
                        ...
                        <ul className="property-sale__bonus-list">
                            <li>
                                сдадим Ваш объект в краткосрочную или
                                среднесрочную аренду на время продажи, что
                                позволит получить дополнительный доход от 100
                                тыс. до 1 млн.руб.
                            </li>
                            <li>приведем объект недвижимости в лучший вид</li>
                            <li>сделаем клининг и фотосессию</li>
                            <li>
                                организуем комплексное управление объектом и
                                арендным потоком
                            </li>
                            <li>
                                самостоятельно организуем показы, привлечем
                                трафик на готовый арендный бизнес, проведем
                                сделку
                            </li>
                        </ul>
